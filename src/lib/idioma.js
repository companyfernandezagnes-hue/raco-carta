...
const TEXTOS = {
  es: {
    ...
    filtroDO: 'D.O.', doTodas: 'D.O.: todas',
  ...
  ca: {
    ...
    filtroDO: 'D.O.', doTodas: 'D.O.: totes',
    tipoTodos: 'Tipus: tots', paisTodos: 'País: tots',
    sinAlcohol: 'Sense Alcohol',
  ...
  de: {
    ...
    filtroDO: 'D.O.', doTodas: 'D.O.: alle',
    tipoTodos: 'Typ: alle', paisTodos: 'Land: alle',
    sinAlcohol: 'Alkoholfrei',
